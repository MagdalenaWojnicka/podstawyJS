/*
 ...
 =====================================================
/*
1. Napisz funkcje, która zwraca losową całkowitą liczbę, w zadanym zasięgu (zasięg to parametr):
 e.g getRandomValue(10) - zwraca losową, całkowita liczbę w zasięgu od 1 do 10
 e.g getRandomValue(1023) - zwraca losową, całkowita liczbę w zasięgu od 1 do 1023
...
2. Napisz funkcję, która jako parametr przyjmuje Twoje imię i nazwisko,
 ...
 e.g getInitials("John Doe") - zwraca "J.K"
